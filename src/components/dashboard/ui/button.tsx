...
/**
 * Dashboard-only Button variants: flat (no shadow/elevation), denser control
 * height (GitHub Primer feel). Forked from `@/components/ui/button` so public
 * routes keep their original elevated buttons untouched.
 */
...
Button.displayName = "DashboardButton"
